...
var tarteaucitron = {
    ...
    "load": function () {
        ...
        tarteaucitron.addInternalScript(pathToLang, '', function () {
            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                html += '            <label><input type="radio" name="tarteaucitronScrollbarAdjustBtn"  id="tarteaucitronAllAllowed" class="tarteaucitronAllow">'+ tarteaucitron.lang.allowAll + '</label>';
                html += '            <label><input type="radio" name="tarteaucitronScrollbarAdjustBtn"  id="tarteaucitronAllDenied" class="tarteaucitronDeny">' + tarteaucitron.lang.denyAll+ '</label>';
                ...
                if (tarteaucitron.parameters.mandatory == true) {
                    ...
                    html += '            <label><input type="radio"  name="mandatoryname"  class="tarteaucitronAllow">'+ tarteaucitron.lang.allowAll + '</label>';
                    html += '            <label><input type="radio"  name="mandatoryname"  class="tarteaucitronDeny">' + tarteaucitron.lang.denyAll+ '</label>';
    ...
    "addService": function (serviceId) {
        ...
        if (tarteaucitron.added[service.key] !== true) {
            ...
            html += '   </div>';
            html += '   <div class="tarteaucitronAsk">';
            html += '            <label><input type="radio" id="' + service.key + 'Allowed" name="' + service.key + 'name"  class="tarteaucitronAllow">'+ tarteaucitron.lang.allowAll + '</label>';
            html += '            <label><input type="radio" id="' + service.key + 'Denied" name="' + service.key + 'name"  class="tarteaucitronDeny">' + tarteaucitron.lang.denyAll+ '</label>';
    ...
    "userInterface": {
        ...
        "color": function (key, status) {
            ...
            if (status === true) {
                ...
                document.getElementById(key + 'Line').querySelector('.tarteaucitronAllow').checked = true;
            } else if (status === false) {
                document.getElementById(key + 'Line').classList.remove('tarteaucitronIsAllowed');
                document.getElementById(key + 'Line').classList.add('tarteaucitronIsDenied');
                document.getElementById(key + 'Line').querySelector('.tarteaucitronDeny').checked = true;
            }
